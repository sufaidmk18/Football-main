...
def stfdetails(request):
    if request.method == "POST":
        ...
        Staff.objects.create(login_id=request.session["lid"], name=name, dob=dob, contact=contact,
...
def playerlist(request):
    ...
    return render(request, 'original/staff/player.html', context)
...
def stfcoaches(request):
    ...
    return render(request, 'original/staff/coaches.html', context)
